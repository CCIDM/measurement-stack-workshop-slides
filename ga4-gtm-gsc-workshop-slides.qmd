...
- Access Starter Quarto Portfolio Website Repo <https://github.com/CCIDM/portfolio-website-template>
...
::: {.notes}
- The items are only needed if they want to publish/deploy the Quarto site during/after the workshop.
...
**Rule #1:** We do *not* put GA4 code directly on the site
**Rule #2:** We put **GTM code** on the site
**Rule #3:** GTM sends the data to GA4
